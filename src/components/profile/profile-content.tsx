...
export function ProfileContent() {
  ...
  const [publickKey, setPublicKey] = useState<string | null>(null);
  ...
  React.useEffect(() => {
    const fetchJudges = async () => {
      ...
      const status = data.data.documents.find(
        (judge: any) => judge.email === user.email
      );
  ...
  const handleSendVerification = async () => {
    ...
    try {
      ...
      const requestVerificatioResult = await fetch(
        "/api/notify/request-verification",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            ...
            >
              ...
              <div className="flex flex-row mt-4 justify-center flex-grow gap-x-10">
                {isEditing ? (
                  <>
                    <Button
                      state={loading ? "disabled" : "initial"}
                    ...
                    <Button
                      ...
                      className="p-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center"
                    >
                      Cancel
                    </Button>
                  </>
                  ...
                  <>
                    <Button
                      ...
                      state={publicKey ? "initial" : "disabled"}
