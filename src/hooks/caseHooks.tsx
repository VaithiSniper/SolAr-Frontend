...
import { IDL as solarIDL } from '../constants/idl'
...
export function useCase() {
  ...
  const program = useMemo(() => {
    if (anchorWallet) {
      ...
      return new anchor.Program(solarIDL, TODO_PROGRAM_PUBKEY, provider)
    }
    ...
    const getCases = async () => {
      if (program && publicKey && !transactionPending) {
        try {
          ...
          const profileAccount = await program.account.Case
          if (profileAccount) {
